...
class MeetingDateServiceTest {
  ...
  public void testMeetingDateCreateThrowsAPIExceptionForDuplicateMeetingDate() {
    ...
    assertEquals(APIExceptionType.CREATE_MEETING_DATE_DUPLICATE_DATE, ex.getExceptionType());
    verifyNoInteractions(auditService);
  }
  ...
  public void testMeetingDateUpdateThrowsAPIExceptionForMeetingDateWithAuthorisations() {
    ...
    assertEquals(APIExceptionType.UPDATE_MEETING_DATE_HAS_AUTHORISATIONS, ex.getExceptionType());
    verifyNoInteractions(auditService);
  }
  ...
  public void testMeetingDateUpdateThrowsAPIExceptionForDuplicateMeetingDate() {
    ...
    assertEquals(APIExceptionType.UPDATE_MEETING_DATE_DUPLICATE_DATE, ex.getExceptionType());
    verifyNoInteractions(auditService);
  }
  ...
  public void testMeetingDateDeleteThrowsAPIExceptionForMeetingDateWithAuthorisations() {
    ...
    assertEquals(APIExceptionType.DELETE_MEETING_DATE_HAS_AUTHORISATIONS, ex.getExceptionType());
    verifyNoInteractions(auditService);
  }
}
